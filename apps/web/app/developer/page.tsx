      ...
      <div className={styles.page}>
        <section className={styles.hero}>
          <div>
            ...
            <p className={styles.lede}>A developer platform for connecting applications to Ori&apos;s intelligence, tools, projects, and future execution capabilities.</p>
          ...
          <div className={styles.statusCard} aria-label="Developer platform status"><div className={styles.statusTop}><span className={styles.statusDot} /><span>Platform foundation</span></div><strong>In active development</strong><p>The public surface is being built from stable platform boundaries rather than exposing internal implementation details.</p></div>
        </section>
        ...
        <section className={styles.platform} aria-labelledby="platform-heading"><div><p className={styles.eyebrow}>PLATFORM SURFACE</p><h2 id="platform-heading">One platform. Clear boundaries.</h2><p>Ori Platform is the main product. The Developer Platform sits inside it and gives developers stable interfaces around projects, intelligence, tools, authentication, events, and documentation.</p></div><div className={styles.pieceGrid} aria-label="Developer platform components">{platformPieces.map((piece, index) => <span key={piece} className={index === 0 ? styles.pieceFeatured : styles.piece}>{piece}</span>)}</div></section>
